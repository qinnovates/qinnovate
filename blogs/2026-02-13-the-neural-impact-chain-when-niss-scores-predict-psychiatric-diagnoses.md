...
*The Neural Impact Chain is documented in [QIF Derivation Log, Entry 53](https://qinnovate.com/framework/). The NISS-DSM Bridge and diagnostic cluster methodology are detailed in the [TARA specification](https://qinnovate.com/TARA). All AI contributions are disclosed in the [AI Transparency Log](https://qinnovate.com). This work was reviewed by Gemini 2.5 Pro and validated against neuroscience literature.*
