...
disclose the following. Large language models (Claude~4, Gemini~2.0, ChatGPT~4o)
...
to the related work. This revision (v1.4) adds the missing Sherman \&
...
classification label (75.5\% includes confirmed, probable, and possible
analogs), and completes a full citation and claims verification pass.

\noindent\textbf{Note on AI use and preprint status:} Zenodo's terms of use
do not prohibit AI-assisted content in deposited works. The author leveraged
AI tools during the development of this preprint to accelerate initial
exploration and plant the seed for a formal contribution to the field.
However, the framework, methodology, and conclusions presented here require
substantial further development---including collaboration with domain experts,
independent empirical validation, clinical review of DSM-5-TR mappings, and
additional revisions---before they can be considered mature. This preprint
represents a starting point, not a finished product.
