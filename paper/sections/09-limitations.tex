...
and database lookup. A full post-mortem is available in the project
repository. This revision (v1.2) corrects an internal percentage
inconsistency and adds the author responsibility statement above.
