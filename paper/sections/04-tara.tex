...
attack techniques with the granularity of MITRE ATT\&CK~\cite{mitre2024attack}
but extended to cover neural, cognitive, and physical safety domains. Each
...
\paragraph{Tactics.}
The 15 tactics map to ATT\&CK lifecycle stages adapted for BCI operations:
...
(TMS)~\cite{krauss2021tms}, and neurofeedback.
