...
export const GLOSSARY_TERMS: GlossaryTerm[] = [
  ...
  {
    id: 'qnis',
    term: 'QNIS (QIF Neural Impact Score)',
    type: 'metric',
    shortDef: 'Purpose-built vulnerability scoring for neural security (0-10 scale).',
    fullDef: 'Developed by Qinnovate as an alternative to CVSS for neural interfaces. Weights human impact at 70% and system exploitability at 30%. Adds dimensions CVSS lacks: Biological Impact, Cognitive Integrity, Reversibility, Violation of Consent, and Neuroplasticity. Severity: Critical (9.0+), High (7.0-8.9), Medium (4.0-6.9), Low (0.1-3.9).',
  ...
  },
  {
    ...
    fullDef: 'A comprehensive threat registry platform organizing BCI threats across Security, Clinical, Governance, and Engineering domains. Contains technique entries scored with QNIS and classified using the QIF Locus Taxonomy. Provides filterable, searchable access to the full QIF threat model.',
    relatedTerms: ['qnis', 'locus-taxonomy'],
    href: '/TARA/',
  ...
  },
  {
    ...
    relatedTerms: ['qnis', 'tara', 'hourglass-model'],
