...
export const PILLARS = [
  ...
  },
  {
    ...
    tagline: 'The threat registry',
    description: '103 BCI techniques mapped across four projections — modality, clinical, diagnostic (DSM-5-TR), and governance — each scored with NISS and traced through the Neural Impact Chain from attack to clinical outcome.',
    href: '/TARA/',
    icon: '&#9650;',
    color: '#f59e0b',
    version: '1.0',
